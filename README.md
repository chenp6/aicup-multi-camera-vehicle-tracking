...
(4) 利用UCMCTrack提供的[Camera Parameter Estimation Tool][(https://github.com/WongKinYiu/yolov7](https://github.com/corfyi/UCMCTrack?tab=readme-ov-file#-camera-parameter-estimation-tool)) 建立各鏡頭的相機參數檔案並放入`camera_para_files`中  
